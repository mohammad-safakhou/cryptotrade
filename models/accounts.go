...
type Account struct {
	...
	APIPassPhrase null.String `boil:"api_pass_phrase" json:"api_pass_phrase,omitempty" toml:"api_pass_phrase" yaml:"api_pass_phrase,omitempty"`
	APIKeyVersion null.Int    `boil:"api_key_version" json:"api_key_version,omitempty" toml:"api_key_version" yaml:"api_key_version,omitempty"`
...
var AccountTableColumns = struct {
	...
	ID:            "accounts.id",
	Name:          "accounts.name",
	BaseURL:       "accounts.base_url",
	APIKey:        "accounts.api_key",
	APISecret:     "accounts.api_secret",
	APIPassPhrase: "accounts.api_pass_phrase",
	APIKeyVersion: "accounts.api_key_version",
...
var AccountWhere = struct {
	...
	APISecret     whereHelpernull_String
	APIPassPhrase whereHelpernull_String
	APIKeyVersion whereHelpernull_Int
	CreatedAt     whereHelpernull_Time
	UpdatedAt     whereHelpernull_Time
	DeletedAt     whereHelpernull_Time
}{
	ID:            whereHelperint{field: "\"accounts\".\"id\""},
	Name:          whereHelpernull_String{field: "\"accounts\".\"name\""},
	BaseURL:       whereHelpernull_String{field: "\"accounts\".\"base_url\""},
	APIKey:        whereHelpernull_String{field: "\"accounts\".\"api_key\""},
	APISecret:     whereHelpernull_String{field: "\"accounts\".\"api_secret\""},
	APIPassPhrase: whereHelpernull_String{field: "\"accounts\".\"api_pass_phrase\""},
	APIKeyVersion: whereHelpernull_Int{field: "\"accounts\".\"api_key_version\""},
...
var (
	accountAllColumns            = []string{"id", "name", "base_url", "api_key", "api_secret", "api_pass_phrase", "api_key_version", "created_at", "updated_at", "deleted_at"}
	accountColumnsWithoutDefault = []string{}
	accountColumnsWithDefault    = []string{"id", "name", "base_url", "api_key", "api_secret", "api_pass_phrase", "api_key_version", "created_at", "updated_at", "deleted_at"}
