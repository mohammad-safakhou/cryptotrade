...
var (
	...
	candlesContentColumnsWithoutDefault = []string{"time_frame", "opening", "closing", "highest", "lowest", "volume", "amount", "created_at", "updated_at", "deleted_at"}
	candlesContentColumnsWithDefault    = []string{"id"}
	candlesContentPrimaryKeyColumns     = []string{"id"}
)

type (
	// CandlesContentSlice is an alias for a slice of pointers to CandlesContent.
	// This should generally be used opposed to []CandlesContent.
